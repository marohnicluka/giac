...
#pragma diag_suppress 61
  ...
  enum maple_conversion {
    ...
    _NLP_INTEGER = 143,            // nlp_integer
    _NLP_INTEGERVARIABLES = 144,   // nlp_integervariables
    _NLP_BINARY = 145,             // nlp_binary
    _NLP_BINARYVARIABLES = 146,    // nlp_binaryvariables
    _NLP_NONNEGINT = 147,          // nlp_nonnegint
    _NLP_METHOD = 148,             // nlp_method
    _NLP_TOLERANCE = 149,          // nlp_tolerance
    _NLP_VERBOSE = 150,            // nlp_verbose
    ...
    _KDE_BINS = 161,               // bins
    _ANN_HALF_MSE = 162,           // MSE
    _ANN_CROSS_ENTROPY = 163,      // cross_entropy
    _ANN_LOG_LOSS = 164,           // log_loss
    _ANN_BLOCK_SIZE = 165,         // block_size
    _ANN_MOMENTUM = 166,           // momentum
    _ANN_TOPOLOGY = 167,           // topology
    _ANN_LEARNING_RATE = 168,      // learning_rate
    _ANN_WEIGHT_DECAY = 169,       // weight_decay
    _ANN_RELU = 170,               // ReLU
  };
