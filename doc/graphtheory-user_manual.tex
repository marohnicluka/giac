...
\subsection{Edge weights : {\tt set\_edge\_weight}, {\tt get\_edge\_weight}, {\tt weight\_matrix}}
...
The command {\tt get\_edge\_weight} accepts two arguments, a weighted graph $ G(V,E) $ and an edge or arc $ e\in E $, and returns the weight of $ e $.

For example, input :
\begin{center}
  \tt G:=graph(\%\{[[1,2],4],[[2,3],5]\%\})
\end{center}
Output :
\begin{center}
