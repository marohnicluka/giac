...
public:
    ...
    ivector translate_indices_to(const graphe &G,const ivector &indices) const;
    ivector translate_indices_from(const graphe &G,const ivector &indices) const;
    ...
    bool planar_embedding_connected(std::vector<ivector> &faces) const;
